    ...
    <main class="max-w-6xl mx-auto p-2 md:p-8 mt-4 md:mt-10">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                ...
                <div class="card bg-base-100 shadow-xl overflow-hidden">
                    ...
                    <div class="card-body items-center text-center -mt-12 md:-mt-16 p-6">
                        <div class="avatar placeholder">
                            <div class="bg-neutral text-neutral-content rounded-full w-20 md:w-24 ring ring-primary ring-offset-base-100 ring-offset-2">
                                <span class="text-2xl md:text-3xl font-bold"><?php echo substr($_SESSION["username"], 0, 1); ?></span>
                            </div>
                        </div>
            ...
            <div class="lg:col-span-2 flex flex-col gap-4 md:gap-6">
                ...
                <div class="bg-base-100 p-6 md:p-8 rounded-2xl shadow-xl flex items-center justify-between overflow-hidden relative">
                    <div class="z-10 pr-4">
                    ...
                    <i data-lucide="terminal" class="w-20 h-20 md:w-32 md:h-32 absolute -right-4 -bottom-4 opacity-5 text-primary"></i>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="card bg-primary text-primary-content shadow-xl cursor-pointer hover:scale-95 transition-transform">
                        <div class="card-body p-4 items-center text-center">
                            <i data-lucide="award" class="w-6 h-6 mb-1"></i>
                            <span class="text-[10px] font-bold uppercase tracking-wider">Défis</span>
                        </div>
                    </div>
                    <div class="card bg-secondary text-secondary-content shadow-xl cursor-pointer hover:scale-95 transition-transform">
                        <div class="card-body p-4 items-center text-center">
