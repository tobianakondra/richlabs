            ...
            <div class="card bg-base-100 shadow-2xl">
                <div class="card-body p-6 md:p-8">
                    ...
                    >
                        ...
                        <div class="form-control">
                            ...
                            <div class="input input-bordered flex items-center gap-2">
                                ...
                                <input type="password" name="confirm_password" placeholder="••••••••" class="grow" required />
                            </div>
                        </div>
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer justify-start gap-3">
                                ...
                                <span class="label-text">J'accepte les <a href="#" class="link link-primary">conditions d'utilisation</a></span>
                            </label>
                        </div>
                    ...
                    <div class="text-center mt-6">
                        ...
                        <a href="login.html" class="link link-primary font-semibold ml-1">Se connecter</a>
                    </div>
                </div>
            </div>
